...
seoDescription: "How to integrate P2P Media Loader into Android and iOS apps: native Android and Flutter on iOS/Android, with step-by-step setup and the pros and cons of each."
---

import { Picture } from "astro:assets";
import flutter_example_image from "../../assets/flutter_demo_example.jpg";
import kotlin_architecture from "../../assets/kotlin-diagram.png";
...
Check our mobile apps repositories for technical details:

- [P2P Media Loader Flutter](https://github.com/Novage/p2p-media-loader-flutter-demo)
- [P2P Media Loader Android](https://github.com/Novage/p2p-media-loader-mobile)

## Flutter Integration (iOS and Android)

<Picture
  src={flutter_example_image}
  formats={["avif", "webp"]}
  alt="Flutter Demo Example"
  loading="eager"
  decoding="auto"
/>
...
<Picture
  src={kotlin_architecture}
  formats={["avif", "webp"]}
  alt="Kotlin Library Architecture"
  loading="eager"
  decoding="auto"
/>
